    ...
    <div className="fixed inset-0 overlay-bg z-50 flex items-start justify-center pt-6 px-4 overflow-y-auto">
      <div className="bg-navy-800 border border-navy-600 rounded-2xl w-full max-w-2xl mb-6">
        <div className="flex items-center justify-between px-6 py-4 border-b border-navy-700">
          <h2 className="text-xl font-bold text-theme-primary">Nová etiketa</h2>
        ...
        {result ? (
          <div className="px-6 py-8 text-center">
            <div className="text-green-400 text-2xl font-bold mb-2">Etiketa vygenerována</div>
          ...
          <div className="px-6 py-4 space-y-4">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="text-theme-muted text-xs mb-1 block">Přepravce *</label>
              ...
              {form.shipperCode && services.length > 0 && (
                <div className="flex-1">
                  <label className="text-theme-muted text-xs mb-1 block">Služba *</label>
            ...
            {/* Recipient */}
            <div>
              <label className="text-theme-muted text-xs mb-1 block">Jméno / firma *</label>
              <input value={form.recipientName} onChange={e => set('recipientName', e.target.value)} placeholder="Jan Novák" className={inputCls} />
            </div>
            <div>
              <label className="text-theme-muted text-xs mb-1 block">Ulice</label>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="col-span-2">
                <label className="text-theme-muted text-xs mb-1 block">Město *</label>
                <input value={form.recipientCity} onChange={e => set('recipientCity', e.target.value)} placeholder="Praha" className={inputCls} />
              </div>
              <div>
                <label className="text-theme-muted text-xs mb-1 block">PSČ *</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="text-theme-muted text-xs mb-1 block">Stát</label>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                <label className="text-theme-muted text-xs mb-1 block">Dobírka</label>
            ...
            <div className="flex justify-end gap-3 pt-2 border-t border-navy-700">
              ...
              >
                {generating ? 'Generuji...' : 'Generovat etiketu'}
              </button>
            </div>
          </div>
        )}
