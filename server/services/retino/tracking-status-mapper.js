...
const STATUS_RULES = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /rollkarte|depo vstup|hub inbound/i,
...
const SUB_STATUS_RULES = [
  ...
  { sub: 'distribution_center', patterns: [/distribu[cč]/i, /za[rř][ií]zen[ií]/i, /zpracov[aá]n[ií] v/i, /hub inbound/i] },
...
const DESCRIPTION_TRANSLATIONS = {
  ...
  'hub storage': 'Uloženo na HUB — vrácení odesílateli',
