...
const allowedOrigins = process.env.ALLOWED_ORIGINS
  ...
  : ['http://localhost:5173', 'http://localhost:4173', 'https://labelhunter-client.onrender.com', 'https://labelhunter.mroautoapp.cz', 'https://retino.mroautoapp.cz', 'https://returo.mroautoapp.cz'];
app.use(cors({
  origin: (origin, cb) => {
